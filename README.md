...
- [Utilising MLflow (Temperature: OLS, decision tree, and Random Forest).](https://github.com/mennosmit-dev/Machine-Learning-Engineer---Career-Track/blob/main/07_Predicting_Temperature_in_London/temperature_prediction.py)) – OLS RMSE: **0.88**, Decison Tree RMSE: **0.86** Random Forest RMSE: **1.01**.  
