...
- Currently writing my MSc. thesis on the application of RL (PPO/SAC/DDPG) to the long-term portfolio management optimisation problem. After finishing the research will be using it for myself in production with weekly automatic data extraction, transformation, and loading (ETL); training; automatic portfolio investment and monitoring (through APIs).
