...
- [Finding relevant articles on wikipedia (Utilising Spark instance on EMr with EMR cluster)](https://github.com/mennosmit-dev/AWS-ML-Engineer-Associate-MLA-C01/blob/main/03_Data_Transformation_Integrity_Feature_Engineering/pyspark_wikipedia_tfidf_search.py) – Got very reasonable working model for a variety of different input words.
