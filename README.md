...
## 🏠 Utilising CNN and CV to forest housing prices [Discussion_Paper](https://github.com/mennosmit-dev/Econometric_Modelling/blob/main/discussion_paper.pdf)
...
random forest approach to predict housing prices in Rotterdam.
